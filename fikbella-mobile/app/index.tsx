        ...
        >
          ...
          >
            ...
            <Pressable className="items-end mt-3">
              <Text className="text-pink-600 text-sm font-medium">Esqueci minha senha</Text>
            </Pressable>

            {/* botão entrar */}
            <Pressable className="bg-pink-600 rounded-2xl py-4 mt-8 flex-row items-center justify-center">
              <Text className="text-white font-semibold text-base mr-2">Entrar</Text>
            ...
            <View className="flex-row justify-center mt-6">
              ...
              <Pressable>
                <Text className="text-pink-600 text-sm font-semibold">Crie sua conta</Text>
              </Pressable>
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
